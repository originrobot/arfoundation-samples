...
#else
        protected void startProcess(ref System.Diagnostics.Process process, int timeout = 0, bool eventOutputData = false, bool eventErrorData = false, bool redirectOutputData = true, bool redirectErrorData = true)
#endif
        {
            try
            {
